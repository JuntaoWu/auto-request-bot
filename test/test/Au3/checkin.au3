...
Global $argUrl = $argc > 0 ? $CmdLine[1] : "http://qyhgateway.ihxlife.com/api/v1/other/query/authorize?timestamp=1546523890746&nonce=7150788195ff4a4fa0ae73d56a4245d0&trade_source=TMS&signature=D5CE85CD68327998A7C78EB0D48B806F&data=%7B%22redirectURL%22%3A%22http%3A%2F%2Ftms.ihxlife.com%2Ftms%2Fhtml%2F1_kqlr%2Fsign.html%22%2C%22attach%22%3A%2200000000000000105723%22%7D"
Global $userCount = $argc > 1 ? $CmdLine[2] : 1

;~ $argUrl = "http://www.baidu.com/"

;~ _DebugOut("argc, argv:" & $argc & $CmdLine[1] & $CmdLine[2])
